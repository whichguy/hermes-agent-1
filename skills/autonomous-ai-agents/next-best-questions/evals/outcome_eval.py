...
def simulator_prompt(hidden_spec, question):
    return (
        ...
        "Rules (strict): if — and only if — your spec genuinely resolves the question, answer "
        "it briefly using ONLY information from the spec. If the spec does not address it, or "
        "the question is generic fishing, reply with exactly:\n"
        f"{NO_ANSWER}\n"
